...
function Simulacro () {
    ...
    // console.log(fisherYatesShuffle( [1, 3, 5]));
                        ...
                        <p className={style.ask}>{simulacro[router.query.Index - 1].pregunta}</p>
                            ...
                            <BlackFont>
                                <div className={style.answersContainer}>
                                    <div className={`${style.box} ${objet.selected == 1 && objet.selected !== objet.nFour ? style.red : ''}  ${objet.selected !== null && 1 == objet.nFour ? style.green : ''}`} onClick={(e) => { select(1) }} > {objet.nFour == 1 ? objet.res : objet.res + 5} {simulacro[router.query.Index - 1].a} </div>
